...
execute unless score #global.atp_miner dp_vmn.global_setting matches 1 as @a at @s unless score @s dp_vmn.ATPminer.sneaking_mode matches 1 run function vmn:main/vmn/player_digging2
execute unless score #global.atp_miner dp_vmn.global_setting matches 1 as @a at @s if score @s dp_vmn.ATPminer.sneaking_mode matches 1 if score @s dp_vmn.sneaking_time matches 1.. run function vmn:main/vmn/player_digging2
