...
# 苍白橡树
execute if score #block_value dp_vmn.temp matches 830 if block ~1 ~1 ~ minecraft:pale_oak_log if block ~ ~1 ~1 minecraft:pale_oak_log store result score #sapling dp_vmn.temp run clear @p[tag=dp_vmn_TEMP] minecraft:pale_oak_sapling 0
execute if score #block_value dp_vmn.temp matches 830 if block ~1 ~1 ~ minecraft:pale_oak_log if block ~ ~1 ~1 minecraft:pale_oak_log if score #sapling dp_vmn.temp matches 4.. run clear @p[tag=dp_vmn_TEMP] minecraft:pale_oak_sapling 4
execute if score #block_value dp_vmn.temp matches 830 if block ~1 ~1 ~ minecraft:pale_oak_log if block ~ ~1 ~1 minecraft:pale_oak_log if score #sapling dp_vmn.temp matches 4.. run tag @s add dp_vmn_GIANT
execute if score #block_value dp_vmn.temp matches 830 if block ~1 ~1 ~ minecraft:pale_oak_log if block ~ ~1 ~1 minecraft:pale_oak_log if score #sapling dp_vmn.temp matches 4.. run tag @s add dp_vmn_SAPLING
