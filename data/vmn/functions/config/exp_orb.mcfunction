...
execute if block ~ ~ ~ minecraft:sculk run scoreboard players add #exp_orb_value dp_vmn.temp 1
execute if block ~ ~ ~ minecraft:sculk_catalyst run scoreboard players add #exp_orb_value dp_vmn.temp 5
execute if block ~ ~ ~ minecraft:sculk_sensor run scoreboard players add #exp_orb_value dp_vmn.temp 5
execute if block ~ ~ ~ minecraft:calibrated_sculk_sensor run scoreboard players add #exp_orb_value dp_vmn.temp 5
execute if block ~ ~ ~ minecraft:sculk_shrieker run scoreboard players add #exp_orb_value dp_vmn.temp 5
