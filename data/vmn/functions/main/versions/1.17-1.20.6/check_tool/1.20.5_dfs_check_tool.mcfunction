...
execute if data entity @s SelectedItem.components."!minecraft:damage" run scoreboard players set #temp_secret dp_vmn.temp 3159
execute if data entity @s SelectedItem.components."minecraft:unbreakable" run scoreboard players set #temp_secret dp_vmn.temp 3159
execute if predicate vmn:if_items/whitelist_tool run scoreboard players set #temp_secret dp_vmn.temp 3159
execute unless data entity @s SelectedItem.components."minecraft:max_damage" unless predicate vmn:if_items/damage_tool run scoreboard players set #temp_secret dp_vmn.temp 3159
...
execute unless score #temp_secret dp_vmn.temp matches 3159 unless data entity @s SelectedItem.components."minecraft:max_damage" if predicate vmn:if_items/damage_tool unless score #dfs_max_damage dp_vmn.temp matches 1.. run function vmn:main/vmn/check_tool3
...
execute unless score #temp_secret dp_vmn.temp matches 3159 if data entity @s SelectedItem.components."minecraft:max_damage" unless score #dfs_max_damage dp_vmn.temp matches 1.. store result score #dfs_max_damage dp_vmn.temp run data get entity @s SelectedItem.components."minecraft:max_damage" 1
...
execute unless score #temp_secret dp_vmn.temp matches 3159 store result score #dfs_unbreaking dp_vmn.temp run data get entity @s SelectedItem.components."minecraft:enchantments".levels."minecraft:unbreaking" 1
execute unless score #temp_secret dp_vmn.temp matches 3159 run scoreboard players add #dfs_unbreaking dp_vmn.temp 1
execute unless score #temp_secret dp_vmn.temp matches 3159 store result score #dfs_damage dp_vmn.temp run data get entity @s SelectedItem.components."minecraft:damage" 1
