...
execute as @a unless score @s dp_vmn.ATPminer.basic matches 1 at @s unless score @s dp_vmn.ATPminer.sneaking_mode matches 1 run function vmn:main/vmn/player_digging2
