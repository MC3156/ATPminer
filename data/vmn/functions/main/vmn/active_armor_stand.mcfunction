...
execute unless score @e[type=minecraft:marker,tag=dp_vmn_MAIN,tag=dp_vmn_TEMP,limit=1,sort=nearest] dp_vmn.damage matches -1 if score #temp_version dp_vmn.temp matches ..3818 run function vmn:main/versions/1.17-1.20.6/all_components/active_armor_stand_1.20.4
