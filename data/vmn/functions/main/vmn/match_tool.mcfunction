...
execute if score #temp_version dp_vmn.temp matches ..3818 run function vmn:main/versions/1.17-1.20.6/all_components/match_tool_1.20.4
...
execute store success score #match_tool dp_vmn.temp run data modify entity @s HandItems[0] set from entity @p[tag=dp_vmn_TEMP] SelectedItem
