...
execute unless score #temp_secret dp_vmn.temp matches 3159 store result score #dfs_unbreaking dp_vmn.temp run data get entity @s SelectedItem.components."minecraft:enchantments"."minecraft:unbreaking" 1
