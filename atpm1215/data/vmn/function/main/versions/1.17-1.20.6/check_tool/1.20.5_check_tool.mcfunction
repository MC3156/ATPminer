...
execute if data entity @s equipment.mainhand.components."!minecraft:damage" run scoreboard players set #temp_secret dp_vmn.temp 3158
execute if data entity @s equipment.mainhand.components."minecraft:unbreakable" run scoreboard players set #temp_secret dp_vmn.temp 3158
execute if predicate vmn:if_items/whitelist_tool run scoreboard players set #temp_secret dp_vmn.temp 3158
execute unless data entity @s equipment.mainhand.components."minecraft:max_damage" unless predicate vmn:if_items/damage_tool run scoreboard players set #temp_secret dp_vmn.temp 3158
...
execute unless score #temp_secret dp_vmn.temp matches 3158 if data entity @s equipment.mainhand.components."minecraft:tool".damage_per_block store result score #damage_per_block dp_vmn.temp run data get entity @s equipment.mainhand.components."minecraft:tool".damage_per_block 1
execute unless score #temp_secret dp_vmn.temp matches 3158 unless data entity @s equipment.mainhand.components."minecraft:max_damage" if predicate vmn:if_items/damage_tool unless score @e[type=minecraft:marker,tag=dp_vmn_TEMP,tag=dp_vmn_MAIN,distance=..0.001,limit=1,sort=nearest] dp_vmn.max_damage matches 1.. run function vmn:main/vmn/check_tool2
execute unless score #temp_secret dp_vmn.temp matches 3158 if data entity @s equipment.mainhand.components."minecraft:max_damage" unless score @e[type=minecraft:marker,tag=dp_vmn_TEMP,tag=dp_vmn_MAIN,distance=..0.001,limit=1,sort=nearest] dp_vmn.max_damage matches 1.. store result score @e[type=minecraft:marker,tag=dp_vmn_TEMP,tag=dp_vmn_MAIN,distance=..0.001,limit=1,sort=nearest] dp_vmn.max_damage run data get entity @s equipment.mainhand.components."minecraft:max_damage" 1
...
execute unless score #temp_secret dp_vmn.temp matches 3158 store result score @e[type=minecraft:marker,tag=dp_vmn_TEMP,tag=dp_vmn_MAIN,distance=..0.001] dp_vmn.unbreaking run data get entity @s equipment.mainhand.components."minecraft:enchantments"."minecraft:unbreaking" 1
...
execute unless score #temp_secret dp_vmn.temp matches 3158 store result score @e[type=minecraft:marker,tag=dp_vmn_TEMP,tag=dp_vmn_MAIN,distance=..0.001] dp_vmn.damage run data get entity @s equipment.mainhand.components."minecraft:damage" 1
