...
execute as @a if predicate vmn:input/sprint run scoreboard players add @s dp_vmn.input_ctrl 1
...
execute as @a unless score @s dp_vmn.ATPminer.basic matches 1 at @s if score @s dp_vmn.ATPminer.sneaking_mode matches 1 if score @s dp_vmn.input_ctrl matches 1.. run function vmn:main/vmn/player_digging2
execute as @a unless score @s dp_vmn.ATPminer.basic matches 1 at @s if score @s dp_vmn.ATPminer.sneaking_mode matches 2 if score @s dp_vmn.sneaking_time matches 1.. run function vmn:main/vmn/player_digging2
